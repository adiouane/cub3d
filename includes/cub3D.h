...
/*   Updated: 2022/11/07 23:24:21 by adiouane         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
/*
	...
	The values of the constants are integers that start at 0 and increase by 1
	The constants are called enumerators.
	to define an enum, we use the keyword enum followed by the name of the enum or the type of the enum.
...
void	positions_player(t_cub *cub, char **map);
// --------------------------  PARSING UTILS ------------------------- //
